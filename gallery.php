...
<body>
    ...
    <div class="slider-wrapper">
        <div class="slider-container">
            ...
            ?>
            <!-- <img class="slider-image" src="uploads/<?php echo $file ?>" /> -->
            <a class="image" href="uploads/<?php echo $file ?>" download><img class="slider-image"
                    src=" uploads/<?php echo $file ?>" />
                <div class="button-background">
                    ...
                    <button class="download">
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none">
                            ...
                            <path stroke="#00ff00" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                d="M8 17.274h8" />
                        </svg>
                    </button>
